...
Since agents can't eat cake, and I'm on a diet, I went for a different present: vibetunnel is now hosted on [vt.sh](https://vt.sh)! Gotta put a claim into the `vt` [command arena](https://github.com/amantus-ai/vibetunnel/issues/342)!