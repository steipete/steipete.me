...
description: >-
  `keyboardShortcut` is a convenient way to add shortcuts in SwiftUI. However,
  it likely won’t work. I was curious why that is, so follow along with me for a
  round of SwiftUI debugging! Spoiler: The workaround is at the end of this
  article.
source: steipete.com
---
