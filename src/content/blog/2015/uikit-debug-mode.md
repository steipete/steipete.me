...
description: "A while ago, I've stumbled on a string called `UIPopoverControllerPaintsTargetRect` in some UIKit disassembly - definitely worth investigating! Now that I finally own [IDA](https:..."
tags:
  - iOS
  - UIKit
  - Debugging
