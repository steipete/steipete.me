...
description: 'div.post-content > img:first-child { display:none; } A few weeks ago, we started receiving support tickets with reports that people can’t use the `lldb` debugger anymore after integrating PSPDFKit.'
